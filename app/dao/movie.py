...
class MovieDAO:
    #обьект будет хранить в себе сессию. Просто импорт from app.database import db не позволит переключаться между
    # БД, если будет нужно. А создав новый обьект с новой сессией в себе в виде атрибута-позволит
